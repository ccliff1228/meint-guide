...
- **06 Claude 선물 사용 가이드** — Claude 선물 구독 활성화(Redeem) 절차와 Claude Code 설정
- **07 GitHub Private Repo 가이드** — 팀 협업을 위한 Collaborator 초대, 브랜치 보호 규칙, Bypass 설정
